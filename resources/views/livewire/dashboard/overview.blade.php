    ...
    <div class="flex flex-col gap-2 items-center justify-between mb-7 sm:flex-row sm:mb-0 w-fulls">
        <div class="sm:ml-1.5 sm:w-auto w-full">
            ...
            <select 
                ...
                id="account" 
                name="account" 
                class="bg-gray-50 bg-transparent cursor-pointer focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-100 font-medium hover:bg-white px-2 py-2 rounded-t sm:w-auto text-gray-900 text-lg w-full"
            >
        ...
        <div class="flex gap-2 items-center ml-2 sm:ml-0 sm:w-auto w-full">
            ...
            <select 
                ...
                id="category" 
                name="category" 
                class="bg-gray-50 bg-transparent cursor-pointer focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-100 font-medium hover:bg-white mr-1.5 px-2 py-1.5 rounded-t sm:w-auto text-gray-900 text-sm w-full"
            >
