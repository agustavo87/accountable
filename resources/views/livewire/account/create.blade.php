                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <div class="relative mt-1 rounded-md shadow-sm">
                                            ...
                                            <input type="text" name="description" id="description"
                                                ...
                                                class="block w-full rounded-md border-gray-300 pl-7 pr-12 focus:border-cyan-500 focus:ring-cyan-500 sm:text-sm"
                                                placeholder="0.00">
                                            <div class="absolute inset-y-0 right-0 flex items-center">
                                                <label for="currency" class="sr-only">Currency</label>
                                                <select wire:model="account.currency"  id="currency" name="currency"
                                                    class="h-full rounded-md border-transparent bg-transparent py-0 pl-2 pr-7 text-gray-500 focus:border-cyan-500 focus:ring-cyan-500 sm:text-sm">
