                    ...
                    <form 
                        ...
                        <div class="shadow sm:overflow-hidden sm:rounded-md">
                                                    ...
                                                    <div class="px-4 py-4 sm:px-6">
                                                        ...
                                                        <div class="grid grid-cols-6 gap-6">
                                                            ...
                                                            <div class="col-span-6 sm:col-span-3 flex flex-col">
                                                                ...
                                                                <div class="flex justify-end">
                                                                    ...
                                                                    <a  
                                                                        ...
                                                                        class="mt-1 mr-1 self-end text-xs text-cyan-500 hover:text-cyan-400 font-medium"
                                                                        >Create</a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-span-6 flex items-center justify-end sm:col-span-3">
                                                                <button wire:click="commitMovement" type="button" class="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-cyan-500 hover:text-white hover:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 transition-colors">
                            ...
                            <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                                <button type="submit"
                                    class="inline-flex justify-center rounded-md border border-transparent bg-cyan-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2">
                                    Create Operation
                                </button>
                            </div>
                        </div>
