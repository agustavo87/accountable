                    ...
                    @auth
                        <a
                            ...
                            @class([
                                ...
                                'border-indigo-500 text-gray-900' => $currentRoute('account.index'),
                                'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' => !$currentRoute('account.index')
                            ])
                        ...
                        <a
                            ...
                            @class([
                                'inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium',
                                'border-indigo-500 text-gray-900' => $currentRoute('operation.create'),
                                'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' => !$currentRoute('operation.create')
                            ])                            
                            >Create Operation</a>
                        ...
                        <a
                            ...
                            @class([
                                'inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium',
                                'border-indigo-500 text-gray-900' => $currentRoute('operation.index'),
                                'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' => !$currentRoute('operation.index')
                            ])                            
                            >View Operations</a
                        >
                    @endauth
            ...
            @auth
                ...
                <a
                    ...
                    @class([
                        ...
                        'bg-indigo-50 border-indigo-500 text-indigo-700' => $currentRoute('account.index'),
                        'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800' => !$currentRoute('account.index')
                    ])
                    aria-current="page"
                    >Accounts</a
                >
                ...
                <a
                    ...
                    @class([
                        'block pl-3 pr-4 py-2 border-l-4 text-base font-medium',
                        'bg-indigo-50 border-indigo-500 text-indigo-700' => $currentRoute('operation.create'),
                        'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800' => !$currentRoute('operation.create')
                    ])
                    >Create Operation</a
                >
                ...
                <a
                    ...
                    @class([
                        'block pl-3 pr-4 py-2 border-l-4 text-base font-medium',
                        'bg-indigo-50 border-indigo-500 text-indigo-700' => $currentRoute('operation.index'),
                        'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800' => !$currentRoute('operation.index')
                    ])
                    >View Operations</a
                >
            @endauth
